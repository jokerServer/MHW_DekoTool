...
public class Dekoration {
	...
	public Dekoration(int rowNum, int owned, int toBeSmelted, String dekoName, String skillName, String skillDesc,
			int skillMaxLvl, int dekoLvl, int dekoRarity, int dekoRarityWeight, float dekoChanceMysterious,
			float dekoChanceGlowing, float dekoChanceWorn, float dekoChanceWarped, float dekoChanceT1,
			float dekoChanceT2, float dekoChanceT3) {
		this.rowNum = rowNum;
		this.owned = owned;
	...
	public Dekoration clone() {
		return new Dekoration(rowNum, new Integer(owned), toBeSmelted, dekoName, skillName, skillDesc, skillMaxLvl,
				dekoLvl, dekoRarity, dekoRarityWeight, dekoChanceMysterious, dekoChanceGlowing, dekoChanceWorn,
				dekoChanceWarped, dekoChanceT1, dekoChanceT2, dekoChanceT3);
	}
}
